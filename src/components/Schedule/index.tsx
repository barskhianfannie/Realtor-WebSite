...
<div className=" border-b-2  w-full p-4 mb-10 text-center bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
    <h5 className="mb-2 text-3xl font-bold text-gray-900 dark:text-white">File your Taxes from anywhere...</h5>
    <p className="mb-5 text-base text-gray-500 sm:text-lg dark:text-gray-400 italic">Schedule a Remote or In-House appointment with any our tax professionals today!</p>
