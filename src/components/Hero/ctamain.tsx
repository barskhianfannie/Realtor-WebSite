...
const CTAMainSection = () =>{
  return(
    ...
    <div className="py-2 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
        <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Los Angeles Realtor</h1>
        <p className="mb-8 text-md font-normal text-gray-500 lg:text-xl sm:px-8 xl:px-20 dark:text-gray-400">
        ...
        <div className="px-4 mx-auto text-center md:max-w-screen-md lg:max-w-screen-lg lg:px-36">
            ...
            <div className="flex flex-wrap justify-center items-center mt-8 text-gray-500 sm:justify-between">
                ...
                <Image src={zillow} height={50} width={50}/>                     
                </a>
                <a href="" className="mr-5 mb-5 lg:mb-0 hover:text-gray-800 dark:hover:text-gray-400">
                  <Image src={realtor} height={50} width={50} className="rounded-xl"/>
                </a>      
            </div>
        </div> 
    </div>
